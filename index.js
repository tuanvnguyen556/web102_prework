...
function filterUnfundedOnly() {
    ...
    const raisedAmountLessThanGoal = GAMES_JSON.filter((game) => game.pledged < game.goal);
    console.log(raisedAmountLessThanGoal);

    // use the function we previously created to add the unfunded games to the DOM
    addGamesToPage(raisedAmountLessThanGoal);
...
function filterFundedOnly() {
    ...
    const raisedAmountGreaterThanGoal = GAMES_JSON.filter((game) => game.pledged >= game.goal);
    console.log(raisedAmountGreaterThanGoal);

    // use the function we previously created to add unfunded games to the DOM
    addGamesToPage(raisedAmountGreaterThanGoal);
}
// filterFundedOnly();
// show all games
...
descriptionDOM.innerHTML = unfundedGamesString;
descriptionContainer.append(descriptionDOM);
/************************************************************************************
...
let [firstGame, secondGame, ...more] = sortedGames;

// create a new element to hold the name of the top pledge game, then append it to the correct element
const topPledgeGameElement = document.createElement('p');
topPledgeGameElement.innerHTML = firstGame.name;
